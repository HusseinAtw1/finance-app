    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md">
                ...
                <div id="liabilityTemplate" class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2>Liability Payment</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('transactionDetail_liability.store', ['transaction' => $transaction->id]) }}" id="liabilityForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3" id="liabilitySelectDiv">
                                    <label for="liability_id" class="form-label">Select Liability:</label>
                                    <select name="liability_id" id="liability_id" class="form-select" required>
                                ...
                                <div class="col-md-6 mb-3" id="accountDiv">
                                    <label for="account_id" class="form-label">Select Account:</label>
                                    <select name="account_id" id="account_id" class="form-select" required>
                                        <option value="">--Select Account--</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3" id="paidAmountDiv">
                                    <label for="paid_amount" class="form-label">Paid Amount:</label>
                                    <input type="number" name="paid_amount" id="paid_amount" step="0.01" min="0" value="{{ old('paid_amount') }}" class="form-control" required>
                                    @error('paid_amount')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3" id="paidAtDiv">
                                    <label for="paid_at" class="form-label">Payment Date:</label>
                                    <input type="datetime-local" name="paid_at" id="paid_at" value="{{ old('paid_at') }}" class="form-control" required>
                                    @error('paid_at')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">Add Liability to the Payment</button>
                                </div>
                            </div>
                        </form>
                    </div>
